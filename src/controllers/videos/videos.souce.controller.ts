...
export class VideosSourceController {
  ...
  public static async addVideosSource(req: Request, res: Response) {
    try {
      const addVideosSource = await VideosSoureService.addVideosSource(req.body);
  ...
  public static async deleteVideosSourceById(req: Request, res: Response) {
    try {
      const deleteVideosSourceById = await VideosSoureService.deleteVideosSource(req.params.id);
      res.status(200).json({
  ...
  public static async updateVideosSourceById(req: Request, res: Response) {
    try {
      const updateVideosSourceById = await VideosSoureService.updateVideosSource(req.params.id, req.body);
      res.status(200).json({
  ...
  public static async getVideosSourceById(req: Request, res: Response) {
    try {
      const getVideosSourceById = await VideosSoureService.getVideosSourceByVideoId(req.params.id);
  ...
  public static async changeStatus(req: Request, res: Response) {
    try {
      const changeStatus = await VideosSoureService.changeStatusVideosSource(req.params.id, req.body);
      res.status(200).json({
  ...
  public static async getSourceById(req: Request, res: Response) {
    try {
      const getSourceById = await VideosSoureService.getSourceById(req.params.id);
